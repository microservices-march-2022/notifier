...
The following is a set of guidelines for contributing to the notifier. We really appreciate that you are considering contributing!
...
[Code of Conduct](https://github.com/microservices-march-2022/notifier/blob/main/CODE_OF_CONDUCT.md)

## Getting Started

Follow our [Installation Guide](https://github.com/microservices-march-2022/notifier/blob/main/README.md#Installation) to get the notifier up and running.
...
* Fill in [our pull request template](https://github.com/microservices-march-2022/notifier/blob/main/.github/pull_request_template.md).
